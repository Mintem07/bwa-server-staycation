...
module.exports = {
    ...
    deleteCategory : async (req, res) => {
        try {
            ...
            req.flash('alertMessage', 'Warning Delete Category');
    ...
    deleteBank : async (req, res) => {
        try {
            ...
            await fs.unlink(path.join(`public/${bank.imageUrl}`));
            await bank.remove();
            req.flash('alertMessage', 'Warning Delete Bank');
            req.flash('alertStatus', 'warning');
            res.redirect('/admin/bank');
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
    ...
    deleteItem : async (req, res) => {
        try {
            ...
            await item.remove();
            req.flash('alertMessage', 'Warning Delete Item');
            req.flash('alertStatus', 'warning');
            res.redirect('/admin/item');
        } catch (error) {
            req.flash('alertMessage', `${error.message}`);
    ...
    deleteFeature : async (req, res) => {
        ...
        try {
            ...
            req.flash('alertMessage', 'Warning Delete Feature');
            req.flash('alertStatus', 'warning');
            res.redirect(`/admin/item/show-detail-item/${itemId}`);
        } catch (error) {
            console.log(error);
    ...
    deleteActivity : async (req, res) => {
        ...
        try {
            ...
            req.flash('alertMessage', 'Warning Delete Activity');
            req.flash('alertStatus', 'warning');
            res.redirect(`/admin/item/show-detail-item/${itemId}`);
        } catch (error) {
            console.log(error);
